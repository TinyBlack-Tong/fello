...
<div>
    <h1>管理页面</h1>
    <div v-for="(item) in houses_list" :key=item.id>
            <div class="rect" >
                <div class="flex-container-head">
                    <h5 class="name-title" style="color:#006400;">房屋标题:{{item.title}}</h5>
                ...
                <div class="button_box">
                    <div class="dicon"><el-button class="button-color" @click="del(item.id)">删除</el-button></div>
...
export default {
    ...
    methods:{
        ...
        del(id){
            ...
            const _this=this
            this.$axios.delete('http://localhost:8081/api/houses/'+id).then(function(resp){
